...
function VerdictContent() {
    ...
    return (
        <main className="min-h-screen bg-obsidian-core text-ghost-white overflow-hidden relative selection:bg-neon-orchid/30 flex flex-col pt-32">
            ...
            {isDanger && (
                <div className="fixed inset-0 bg-[url('/threat-bg.png')] bg-cover bg-center opacity-20 mix-blend-overlay pointer-events-none z-0 animate-pulse" />
            )}
            {!isDanger && !isWarning && (
                <div className="fixed inset-0 bg-[url('/solution-bg.png')] bg-cover bg-center opacity-20 mix-blend-screen pointer-events-none z-0" />
            )}
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-4 md:p-8">
                ...
                >
                    ...
                    <div className="text-center mb-12 relative">
                        ...
                        >
                            <ScrambleText text={isDanger ? "THREAT DETECTED" : isWarning ? "POTENTIAL RISK" : "TRANSACTION SAFE"} />
                        </motion.h1>
